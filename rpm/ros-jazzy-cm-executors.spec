...
Name:           ros-jazzy-cm-executors
Version:        0.9.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS cm_executors package
...
%changelog
* Wed Aug 13 2025 Janosch Machowinski <j.machowinski@Cellumation.com> - 0.9.1-1
